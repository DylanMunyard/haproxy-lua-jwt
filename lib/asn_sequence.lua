--
-- Source wholly the property of Kong, https://github.com/Kong/kong/blob/master/kong/plugins/jwt/asn_sequence.lua 
--
-- This class it used by jwtverify.lua for encoding the JWT signature using Data Encoding Rules (DER)
-- to produce an ASN.1 representation of the signature. This is required because the openssl.pkey.verify
-- method requires signatures to be in this format. But the JWT tokens using ES256 encryption encode the signature
-- as two 32-byte long integers. 
-- I found this explained things well https://crypto.stackexchange.com/questions/1795/how-can-i-convert-a-der-ecdsa-signature-to-asn-1
-- ASN.1 decoder: https://asn1.io/asn1playground/
